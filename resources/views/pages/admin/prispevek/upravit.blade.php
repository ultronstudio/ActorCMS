...
@section('content')
    <div class="row mt-4">
        ...
        <hr>
        <div class="">
            <form method="POST" action="{{ url('/admin/prispevek/upravit/' . $post->id) }}" id="formular-upravit_prispevek"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="prispevek_slug" name="slug" value="{{ $post->slug }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="thumbnail" id="thumbnail" value="{{ $post->thumbnail }}" style="display: none;" readonly>
                    <div id="thumbnail-preview">
                        @if ($post->thumbnail)
                            <img src="{{ url($post->thumbnail) }}" alt="Thumbnail" style="max-width: auto; max-height: 175px; width: auto; height: 175px !important;">
                        @endif
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="trailer_video" name="trailer_video" value="{{ $post->trailer_youtube_url }}"
                        class="form-control">
                </div>
                <div class="mb-3">
                    <label for="type" class="form-label">Obsah</label>
                    <textarea name="content" id="obsah" cols="30" rows="10" class="form-control">{{ $post->content }}</textarea>
                </div>
                <div class="mb-3">
